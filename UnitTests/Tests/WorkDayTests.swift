...
class WorkDayTests: XCTestCase {
    ...
    func testDecimalHoursEightPoint0() {
        let hours = WorkDay(weekDay: "Mon", hoursWorked: 8, minutesWorked: 1,
                            arrivalTime: "8:00 AM", departureTime: "3:00 PM")
