...
//        center.addObserver(self, selector: Selector("addArrival:"),
//                                name: NotificationCenter.arrival, object: nil)
//        center.addObserver(self, selector: Selector("addDeparture:"),
//                                name: NotificationCenter.departure, object: nil)
//    }
//
